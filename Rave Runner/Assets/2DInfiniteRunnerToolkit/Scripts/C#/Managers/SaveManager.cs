...
public static class SaveManager : object 
{
	...
	public static int rainbowBraceletUnlocked = 0;
    ...
    public static void LoadData()
    {
		...
		if (!PlayerPrefs.HasKey("Skin ID"))
		{
			...
			PlayerPrefs.SetInt("RainbowBraceletUnlocked", rainbowBraceletUnlocked);

			PlayerPrefs.Save();
		}
		else
		{
			rainbowBraceletUnlocked = PlayerPrefs.GetInt("RainbowBraceletUnlocked");
