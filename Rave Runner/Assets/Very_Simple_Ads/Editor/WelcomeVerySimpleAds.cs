...
namespace AppAdvisory.Ads
{
	...
	public class WelcomeVerySimpleAds : EditorWindow 
	{
		...
		private const string PREFSHOWATSTARTUP = "APPADVISORY.ADS.PREFSHOWATSTARTUP";
		...
		public void OnGUI(){
			...
			if (Button(questionIcon,"A QUESTION? A SUGGESTION? LOOKING FOR A DEVELOPER?","Don't hesitate to contacu us!")){
