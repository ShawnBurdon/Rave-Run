...
public class MovingLayer : MonoBehaviour 
{
    ...
    public static float speedMultiplier;            //The current speed multiplier
    ...
    {   
        ...
        speedMultiplier = 1;
        paused = true;
		if(gameObject.name == "Obstacles-2" || gameObject.name == "Obstacles-3" || gameObject.name == "Obstacles-4")
			paused = false;
    ...
    public virtual void StartGenerating()
    {
        ...
        paused = false;
		if (gameObject.tag != "Obstacles" && gameObject.tag != "Ground")
		{
